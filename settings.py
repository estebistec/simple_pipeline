# Django settings for simple_pipeline project.
...
STATIC_ROOT = os.path.join(PROJECT_ROOT, 'site_static')
...
SECRET_KEY = 't@!djr&^mktjbit-vb#u)zrs6i874=**cj_^(dyple(*qq4v6h'
...
ROOT_URLCONF = 'simple_pipeline.myapp.urls'
